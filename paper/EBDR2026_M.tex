...
%	\end{itemize}
	...
	A engrenagens são adicionadas nos nós correspondentes de cada rotor.  O acoplamento entre os rotres engrenados necessida de uma rigidez associada ao engrenamento.
%	\begin{figure}[H]
%		\centering
