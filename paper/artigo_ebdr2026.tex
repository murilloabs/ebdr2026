...
%	\vspace*{-0.5cm}
	...
	Esse sincronismo decorre do acoplamento giroscópico, no qual a dupla inversão vetorial, imposta pela rotação reversa e pelos momentos fletores opostos do efeito axial, gera momentos reativos síncronos. Vale lembrar que, se o posicionamento do Rotor 2 fosse na posição $y$ a variável $R_y$ que estaria em fase.
