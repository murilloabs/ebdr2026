...
# =========================================================================
#   ADJUSTING PLOT SCALES & ANGLE VIEW
# =========================================================================
max_ampl_plot = 0.15
angleX = 20
angleY = 20
...
# =========================================================================
NE = 24   # number of shaft elements
ND = 2    # number of discs
NM = 2    # number of bearings
CD1 = 6   # node - disc 1 (Python 0-indexed: MATLAB CD1=7)
CD2 = 18  # node - disc 2 (Python 0-indexed: MATLAB CD2=19)
CMM1 = 0  # shaft node - bearing 1 (Python 0-indexed: MATLAB CMM1=1)
CMM2 = 24 # shaft node - bearing 2 (Python 0-indexed: MATLAB CMM2=25)

# Housing nodes (extra nodes beyond shaft nodes)
# Shaft has NE+1 = 25 nodes (0 to 24)
# Housing nodes are added as extra nodes
HOUSING1 = NE + 1  # node 25
HOUSING2 = NE + 2  # node 26
...
MasD = np.pi * Rd**2 * espD * RAl       # disc mass [kg]
Id = 1/4 * MasD * Rd**2 + 1/12 * MasD * espD**2  # transversal MOI [kg*m^2]
Ip = 1/2 * MasD * Rd * Rd              # polar MOI [kg*m^2]
...
# =========================================================================
l = np.zeros(NE)
# First section: 0.140 m divided into 6 elements
for i in range(6):
    l[i] = 0.140 / 6
# Second section: 0.205 m divided into 12 elements
for i in range(6, 18):
    l[i] = 0.205 / 12
# Third section: 0.090 m divided into 6 elements
...
disk1 = rs.DiskElement.from_geometry(
    n=CD1, material=aluminum, width=espD, i_d=0, o_d=2 * Rd
)
disk2 = rs.DiskElement.from_geometry(
    n=CD2, material=aluminum, width=espD, i_d=0, o_d=2 * Rd
)
...
# =========================================================================
# Bearing 1: connects shaft node CMM1 (0) to housing node HOUSING1 (25)
...
# Bearing 2: connects shaft node CMM2 (24) to housing node HOUSING2 (26)
...
print("\n" + "=" * 60)
print("RESULTS DATAFRAME (First 20 modes)")
print("=" * 60)
